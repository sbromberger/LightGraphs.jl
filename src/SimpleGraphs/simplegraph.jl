...
function SimpleGraph(n::Integer=0) where T <: Integer
...
# Graph{UInt8}(adjmx)
function SimpleGraph(adjmx::AbstractMatrix) where T <: Integer
...
function SimpleGraph(g::SimpleGraph) where T <: Integer
