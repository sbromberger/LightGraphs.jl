...
RandomWalk(; nonbacktracking = false, niter = 1, rng = GLOBAL_RNG) =
    RandomWalk(nonbacktracking, niter, rng)
...
"""
walk(g::AbstractGraph, s::Integer, alg::SelfAvoidingWalk) =
    self_avoiding_walk(g, s, alg.niter, alg.rng)
