"""
    centrality(g, distmx=weights(g); normalize=true, alg=Closeness())
...
julia> centrality(star_graph(5), alg=Closeness())
...
julia> centrality(path_graph(4), alg=Closeness())
...
struct Closeness <: CentralityAlgorithm
