...
"""
    struct Betweenness <: CentralityAlgorithm

The structure used to configure and specify that [`centrality`](@ref)
should use the [betweenness centrality](https://en.wikipedia.org/wiki/Centrality#Betweenness_centrality)
...
julia> centrality(star_graph(3))
3-element Array{Float64,1}:
 1.0
 0.0
 0.0

julia> centrality(path_graph(4))
