...
function dfs_tree(g::AbstractGraph, s::Integer; dir = :out)
    ...
    z = dir == :out ? LightGraphs.Traversals.tree(g, s, LightGraphs.Traversals.DepthFirst()) :
...
function dfs_parents(g::AbstractGraph, s::Integer; dir = :out)
    ...
    dir == :out ? LightGraphs.Traversals.parents(g, s, LightGraphs.Traversals.DepthFirst()) :
