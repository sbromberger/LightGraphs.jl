...
"""
    SimpleWeightedDiGraph{T}

A type representing a directed graph with edge weights.
"""
const SimpleWeightedDiGraph = SimpleWeightedGraph
...
edges(g::SimpleWeightedDiGraph) = (WeightedSimpleEdge(x...) for x in zip(findnz(g.weights)...))
