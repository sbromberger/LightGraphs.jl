@testset "Persistence" begin
    ...
    @test_deprecated r"compression no longer supported" savegraph(f, p1; compress=true)
    @test savegraph(f, p1) == 1
    @test_deprecated r"compression no longer supported" savegraph(f, p1, LGFormat(); compress=true)
