@testset "SimpleEdgeIter" begin
    ga = @inferred(SG.SimpleGraph(10, 20; seed=1))
    gb = @inferred(SG.SimpleGraph(10, 20; seed=1))
    dga = @inferred(SG.SimpleDiGraph(10, 20; seed=1))
    dgb = @inferred(SG.SimpleDiGraph(10, 20; seed=1))
