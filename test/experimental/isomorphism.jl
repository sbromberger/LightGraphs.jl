...
@testset "Isomorphism" begin
    ...
    for i in 1:length(cubic_graphs)
        ...
        count_isomorph(g1, g2) ==
        count_isomorph(g2, g1) ==
        count_isomorph(g2, g2)
        @test count_subgraphisomorph(g1, g1) ==
        count_subgraphisomorph(g1, g2) ==
        count_subgraphisomorph(g2, g1) ==
        count_subgraphisomorph(g2, g2)
        @test count_induced_subgraphisomorph(g1, g1) ==
        count_subgraphisomorph(g1, g2) ==
        count_subgraphisomorph(g2, g1) ==
        count_subgraphisomorph(g2, g2)
    end
