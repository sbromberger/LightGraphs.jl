@testset "Connectivity" begin
    ...
    @testset "JarvisShier scc" begin
        ...
        @test @inferred(LC.condensation(fig3)) == fig3_cond

        @test @inferred(LC.attracting_components(fig1)) == Vector[[2, 5]]
        @test @inferred(LC.attracting_components(fig3)) == Vector[[3, 4], [8]]
