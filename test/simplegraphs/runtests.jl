...
@testset "Generator deprecations" begin
    ...
    @test_deprecated CompleteBipartiteGraph(5, 4)
    @test_deprecated CompleteMultipartiteGraph([3, 5])
    @test_deprecated LollipopGraph(3, 2)
    @test_deprecated BarbellGraph(3, 2)
    @test_deprecated TuranGraph(3, 2)
    @test_deprecated CliqueGraph(3, 2)
