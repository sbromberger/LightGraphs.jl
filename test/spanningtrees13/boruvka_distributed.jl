@testset "Boruvka-Distributed" begin
...
# Testing Boruvka's algorithm
    res1 = boruvka_mst_distributed(g,distmx)
    ...
    res2 = boruvka_mst_distributed(g,distmx,minimize=false)
