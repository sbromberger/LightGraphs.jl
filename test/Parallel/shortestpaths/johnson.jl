@testset "Parallel Johnson" begin
    ...
    for g in testgraphs(g3)
        @test @inferred(shortest_paths(g, ParallelJohnson)) == shortest_paths(g, d, ParallelJohnson())
        z = @inferred(shortest_paths(g, d, ParallelJohnson()))
    ...
    for g in testdigraphs(g4)
        z = @inferred(shortest_paths(g, ParallelJohnson()))
